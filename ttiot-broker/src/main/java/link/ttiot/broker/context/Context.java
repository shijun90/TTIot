...
public class Context {
    ...
    public Context build() {
        Context ttIotContext = me();
        if (ttIotContext.dbHelper==null){
            ttIotContext.dbHelper= new RedisDbHelper(new RedisSourceProvider());
        }
        if (ttIotContext.exceptionHandler==null){
            ttIotContext.exceptionHandler=new ExceptionHandlerAdapter();
        }
