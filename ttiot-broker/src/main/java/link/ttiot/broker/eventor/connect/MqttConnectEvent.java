 ...
 * @description:
 */
@Eventor(value = AppProtocalMqttConstant.CONNECT,auth = false)
public class MqttConnectEvent extends MqttApplicationEvent {

    public MqttConnectEvent(MqttMessage msg,ChannelHandlerContext context) {
        super(msg, context);
    }
