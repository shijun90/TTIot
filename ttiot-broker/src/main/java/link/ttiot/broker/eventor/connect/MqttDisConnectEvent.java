 ...
 * @description:
 */
@Eventor(value = AppProtocalMqttConstant.DISCONNECT)
public class MqttDisConnectEvent extends MqttApplicationEvent {

    public MqttDisConnectEvent(MqttMessage msg, ChannelHandlerContext context) {
        super(msg,context);
    }
