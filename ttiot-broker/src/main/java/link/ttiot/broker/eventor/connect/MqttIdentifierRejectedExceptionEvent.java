 ...
 */
@Eventor(auth = false)
public class MqttIdentifierRejectedExceptionEvent extends MqttApplicationEvent {
    public MqttIdentifierRejectedExceptionEvent( MqttMessage msg,ChannelHandlerContext context) {
        super(msg,context);
    }
